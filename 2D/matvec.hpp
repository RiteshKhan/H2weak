...
public:
    ...
    int N;
    int sqrtRootN;
    HODLR2DTree<userkernel> *K;

    initialisation(int sqrtRootN, int nLevels, int nParticlesInLeafAlong1D, double L, int TOL_POW, int Kernel_Choice)
    {
    ...
    void tree_initialisation()
    {
        ...
        this->K = new HODLR2DTree<userkernel>(mykernel, sqrtRootN, nLevels, nParticlesInLeafAlong1D, L, TOL_POW);
