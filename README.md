...
Users can also run the $HODLRdD$ accelerated iterative solver using this repository by changing the flag in `Makefile`. Currently, this repository works for $d=1,2,3$, i.e., in $1D$ D, $2D$ and $3D$.
